...
import { AlignJustifyIcon, LogsIcon, PackageIcon, PaperclipIcon, WeightIcon } from "lucide-react";
    ...
    <header className="flex h-14 lg:h-[60px] items-center gap-4 border-b bg-muted/40 px-6 justify-between lg:justify-end">
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button variant="ghost" size="icon" className="rounded-full border w-8 h-8 lg:hidden">
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button variant="ghost" size="icon" className="rounded-full border w-8 h-8">
            <Image src="/logo.png" width="32" height="32" className="rounded-full" alt="Avatar" />
